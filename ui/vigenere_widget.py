"""Widget pour le chiffrement Vigenère"""
...
class VigenereWidget(QWidget):
    ...
    def init_ui(self):
        ...
        # En-tête
        title = QLabel("<h1>Chiffrement de Vigenère</h1>")
        title.setAlignment(Qt.AlignCenter)
        layout.addWidget(title)

        description = QLabel(
            "Le chiffrement de Vigenère utilise une clé alphabétique "
            "pour effectuer plusieurs chiffrements de César successifs."
        )
        ...
        params_layout.addWidget(QLabel("Clé:"))
        self.key_input = QLineEdit()
        self.key_input.setPlaceholderText("Ex: CRYPTO")
        self.key_input.setMinimumWidth(200)
    ...
    def encrypt_text(self):
        ...
        if not key.isalpha():
            QMessageBox.warning(self, "Attention", "La clé doit contenir uniquement des lettres!")
            return
